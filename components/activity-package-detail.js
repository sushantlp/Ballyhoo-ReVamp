              ...
              <div className="content">
                  ...
                  <div className="column">
                    <h4 className="ffqs fw2 mt0-5 fs1">
                      ...
                      <span className="fw2 mt0-5 fs1-2">
                        {" "}
                        Individual-evo, Individual- Raptor, Individual- Intruder
                      </span>
                    </h4>
                  </div>
                </div>
                ...
                <div className="f14 ffqs">
                  <p style={{ whiteSpace: "pre-line" }}>
                    Go Karting has been the highlights of Torq03. A Renovated
                    track, new karts and never seen before safety barriers
                  </p>
                </div>
              </div>
            </div>
                    ...
                    <div className="content">
                      <div className="columns mb0">
                        <div className="column is-10">
                          <h4 className="ffqs list-title">Individual-evo</h4>

                          <h5 className="fw2 sfc3 mt0-5 fs1-3">₹ 500.00/-</h5>
                        </div>
